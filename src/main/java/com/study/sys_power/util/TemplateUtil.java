...
//			}
	...
	public static void saveService(GenerateInput input) {
		...
		FileUtil.saveTextFile(text, path + File.separator + getPackagePath(input.getServicePkgName())
	...
	public static void saveServiceImpl(GenerateInput input) {
		...
		FileUtil.saveTextFile(text, path + File.separator + getPackagePath(input.getServiceImplPkgName())
